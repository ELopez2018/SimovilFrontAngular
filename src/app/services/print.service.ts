...
>>>>>>> e8b87333225e07782abc708cdb4d6beb9e5832a2
                null;
            } else {
                obj[e] = obj1[e] + obj2[e];
            }
...
>>>>>>> e8b87333225e07782abc708cdb4d6beb9e5832a2
        ...
        if (planilla.TIPO == 'L') {
            planilla.PLA_DIA_TUR.map((e) => {
                let acumItem;
                if (
                    acum2.PLA_DIA_TUR.find((ac) => ac.NUM_TUR == e.NUM_TUR) !==
                    null
                ) {
                    acumItem = acum2.PLA_DIA_TUR.find(
                ...
                e.PLA_DIA_TUR_VEN.map((r) => {
                    const acItm = acumItem.PLA_DIA_TUR_VEN.find(
                ...
                arrayLineA.push(true);
                ingresosObj.push([
                    { text: '', border: [true], colSpan: 2 },
                    {},
                    {},
                    { text: e.CANT_VENTA.toLocaleString(), style: 'right' },
                    {},
                    {},
                    {},
                    {
    ...
    printReceivable(
        ...
        const firmaEDS = [
            {
                text:
                    '\nNota: Favor abonar a la cuenta N° ' +
                    station.cuentaBancaria +
                    ' a nombre de ' +
