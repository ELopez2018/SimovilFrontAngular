...
export class CarteraService {
    ...
    public getDocumentType(): Observable<EntDocumentType[]> {
        return this.http
            .get<EntDocumentType[]>(
                Parametros.GetParametros().servidorLocal + '/api/documentType',
                this.httpOptions
            )
            .pipe(tap((documentTypes) => console.log('Realizado con éxito')));
    }

    public getStationType(): Observable<EntStationType[]> {
        return this.http
            .get<EntStationType[]>(
                Parametros.GetParametros().servidorLocal + '/api/stationType',
                this.httpOptions
            )
            .pipe(tap((types) => console.log('Realizado con éxito')));
    }

    public getPlant(): Observable<EntPlant[]> {
        return this.http
            .get<EntPlant[]>(
                Parametros.GetParametros().servidorLocal + '/api/plant',
                this.httpOptions
            )
            .pipe(tap((types) => console.log('Realizado con éxito')));
    }
    ...
    public getBank(): Observable<EntBank[]> {
        return this.http.get<EntBank[]>(
            Parametros.GetParametros().servidorLocal + '/api/bank',
            this.httpOptions
        );
    }
    public getCompany(nit?: number): Observable<EntCompany[]> {
        const query = '/api/company2';
        const parameters = [[nit, 'nit']];
        const consulta = OrderParametersToGet(query, parameters);
        return this.http.get<EntCompany[]>(
        ...
        return this.http
            .get<EntDepartament[]>(
                Parametros.GetParametros().servidorLocal +
                    '/api/departament/?pais=' +
                    pais,
                this.httpOptions
            )
            .pipe(
                tap((departaments) =>
                    console.log('getDepartament Realizado con éxito')
                )
            );
    }

    public getCodeStation(
        station: number,
        code: string
    ): Observable<EntStationCode[]> {
    ...
    public getUnpaidInvoices(): Observable<EntInvoice[]> {
        return this.http
            ...
            .pipe(
                tap((result) =>
                    console.log(' getUnpaidInvoices Realizado con éxito')
                )
            );
    }
    ...
    public getAttachedTypes(): Observable<EntDailyAttachedType[]> {
        return this.http
            .get<EntDailyAttachedType[]>(
                Parametros.GetParametros().servidorLocal + '/api/attachedType/',
                this.httpOptions
            )
            .pipe(
                tap((result) =>
                    console.log('getAttachedTypes Realizado con éxito')
                )
            );
    }
    ...
    public getArticles(): Observable<EntArticle[]> {
        return this.http
            .get<EntArticle[]>(
                Parametros.GetParametros().servidorLocal + '/api/article/',
                this.httpOptions
            )
    ...
    public getArticleTypes(): Observable<EntArticleType[]> {
        return this.http
            .get<EntArticleType[]>(
                Parametros.GetParametros().servidorLocal + '/api/articleType/',
                this.httpOptions
            )
            .pipe(tap((result) => console.log('Realizado con éxito')));
    }

    public getArticleTypes2(
        station?: number,
        type?: string
    ): Observable<EntArticleType[]> {
    ...
    public GetCarteraForStation(
        ...
        const consulta = OrderParametersToGet(query, parameters);
        return this.http
            .get<ICarteraForStation[]>(
                Parametros.GetParametros().servidorLocal + consulta,
                this.httpOptions
            )
            .pipe(
                tap((data) =>
                    console.log('GetCarteraForStation Realizado con éxito')
                ),
    ...
    public GetFuelTransferedUnloadPending(
        station: number
    ): Observable<EntFuelTransfer[]> {
    ...
    public GetTankReading(
        station: number,
        date?: string,
        type?: number
    ): Observable<EntTankReading[]> {
    ...
    public GetGasReading(
        station: number,
        date?: string
    ): Observable<EntGasReading[]> {
    ...
    public GetOptions(
        ...
        return this.http
            ...
            .pipe(tap((departaments) => console.log('Realizado con éxito')));
    }
                    ...
                    result.map((e) => {
                        e.DE_ACUM_ANTICIPOS != null
                            ? (e.DE_ACUM_ANTICIPOS = JSON.parse(
                                  String(e.DE_ACUM_ANTICIPOS)
                              )[0].Acumulado)
                            : null;
                        e.DE_OTROS_PAGOS != null
                            ? (e.DE_OTROS_PAGOS = JSON.parse(
                                  String(e.DE_OTROS_PAGOS)
                              ))
                            : null;
                        e.DE_ANT_PROV != null
                            ? (e.DE_ANT_PROV = JSON.parse(
                                  String(e.DE_ANT_PROV)
                              ))
                            : null;
                        e.PLA_DIA_PAG_CLI != null
                            ? (e.PLA_DIA_PAG_CLI = JSON.parse(
                                  String(e.PLA_DIA_PAG_CLI)
                              ))
                            : null;
                        e.PLA_DIA_VEN_CLI != null
                            ? (e.PLA_DIA_VEN_CLI = JSON.parse(
                                  String(e.PLA_DIA_VEN_CLI)
                              ))
                            : null;
                        e.PLA_DIA_PAG_CLI_DET != null
                            ? (e.PLA_DIA_PAG_CLI_DET = JSON.parse(
                                  String(e.PLA_DIA_PAG_CLI_DET)
                              ))
                            : null;
                        e.PLA_DIA_VEN_CLI_DET != null
                            ? (e.PLA_DIA_VEN_CLI_DET = JSON.parse(
                                  String(e.PLA_DIA_VEN_CLI_DET)
                              ))
                            : null;
                        e.PLA_DIA_PAG_PRO != null
                            ? (e.PLA_DIA_PAG_PRO = JSON.parse(
                                  String(e.PLA_DIA_PAG_PRO)
                              ))
                            : null;
                        e.PLA_DIA_TUR != null
                            ? (e.PLA_DIA_TUR = JSON.parse(
                                  String(e.PLA_DIA_TUR)
                              ))
                            : null;
                        e.PD_SOPORTE != null
                            ? (e.PD_SOPORTE = JSON.parse(String(e.PD_SOPORTE)))
                            : null;
                    });
                })
            );
                    ...
                    result.map((e) => {
                        ...
                        if (e.PLA_DIA_TUR !== null) {
                            for (let i = 0; i < e.PLA_DIA_TUR.length; i++) {
                                e.PLA_DIA_TUR[i].PLA_DIA_TUR_VEN = JSON.parse(
                                    String(e.PLA_DIA_TUR[i].PLA_DIA_TUR_VEN)
                                );
                            }
                        }
                    });
    ...
    public getReceivable(
        ...
        const consulta = OrderParametersToGet(query, parameters);
        return this.http.get<EntReceivable[]>(
            Parametros.GetParametros().servidorLocal + consulta,
            this.httpOptions
        );
    }
    public MakeReceivable(
        ...
        const CONSUMOS = JSON.stringify(consumos);
        const RETENCIONES = JSON.stringify(retenciones);
        const query = '/api/receivable';
        const body = {
            fechaIni,
            fechaFin,
        ...
        return this.http
            .post<any>(
                Parametros.GetParametros().servidorLocal + query,
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public createReceivableByClient(
        dateIni: string,
        dateEnd: string,
        codClient: number,
        station: number
    ...
    public getReceivablePending(station: number): Observable<EntBasicClient[]> {
        ...
        const parameters = [[station, 'station']];
        const consulta = OrderParametersToGet(query, parameters);
        return this.http.get<EntBasicClient[]>(
            Parametros.GetParametros().servidorLocal + consulta,
            this.httpOptions
        );
    }
        ...
        return this.http
            ...
            .pipe(
                tap((result) => {
                    console.log('Realizado con éxito');
                    result.map((e) => {
                        e.novedadFactura != null
                            ? (e.novedadFactura = JSON.parse(
                                  String(e.novedadFactura)
                              ))
                            : null;
                        e.articulos != null
                            ? (e.articulos = JSON.parse(String(e.articulos)))
                            : null;
                    });
                })
            );
    ...
    public getWholeSalerInvoices(
        station: number,
        pending: boolean = true,
        pendingStation: boolean = true,
        date?: string,
        dateEnd?: string
    ): Observable<EntInvoice[]> {
        ...
        return this.http
            ...
            .pipe(
                tap((result) => {
                    ...
                    result.map((e) => {
                        e.pagos != null
                            ? (e.pagos = JSON.parse(String(e.pagos)))
                            : null;
                    });
                })
            );
    ...
    public getPayment2(
        ...
        return this.http
            ...
            .pipe(
                tap((departaments) =>
                    console.log('Realizado con éxito', departaments)
                )
            );
    }
    ...
    public getBasicClient(): Observable<EntBasicClient[]> {
        return this.http.get<EntBasicClient[]>(
            Parametros.GetParametros().servidorLocal + '/api/basicClient',
            this.httpOptions
        );
    }

    public InsertFuelUnload(
        val: EntFuelUnload,
        transfered: boolean
    ): Observable<any> {
        ...
        return this.http
            .post<EntFuelUnload>(
                Parametros.GetParametros().servidorLocal + '/api/fuelUnload',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertFuelTranfer(val: EntFuelTransfer): Observable<any> {
        ...
        return this.http
            .post<EntFuelUnload>(
                Parametros.GetParametros().servidorLocal + '/api/fuelTransfer',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertTankReading(val: EntTankReading[]): Observable<any> {
        ...
        return this.http
            .post<EntTankReading[]>(
                Parametros.GetParametros().servidorLocal + '/api/tankReading',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertGasReading(val: EntGasReading): Observable<any> {
        ...
        return this.http
            .post<EntGasReading>(
                Parametros.GetParametros().servidorLocal + '/api/gasReading',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertClient(client: EntClient): Observable<EntClient> {
        ...
        return this.http
            .post<EntClient>(
                Parametros.GetParametros().servidorLocal + '/api/client',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertCalibration(structure): Observable<EntCalibration> {
        ...
        return this.http.post<any>(
            Parametros.GetParametros().servidorLocal + '/api/calibration',
            body,
            this.httpOptions
        );
    }
    ...
    public InsertReturn(structure): Observable<EntReturn> {
        const body = JSON.stringify(structure);
        return this.http.post<any>(
            Parametros.GetParametros().servidorLocal + '/api/returned',
            body,
            this.httpOptions
        );
    }
    ...
    public InsertProvider(provider: EntProvider): Observable<EntProvider> {
        ...
        return this.http.post<EntProvider>(
            Parametros.GetParametros().servidorLocal + '/api/provider',
            body,
            this.httpOptions
        );
    }
    ...
    public InsertDailySheet(sheet: EntDailySheet): Observable<EntDailySheet> {
        ...
        return this.http
            .post<EntDailySheet>(
                Parametros.GetParametros().servidorLocal + '/api/dailySheet',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public getTicketConsecutivo(
        station: number,
        data: string
    ): Observable<EntTicketVenta> {
        ...
        const consulta = OrderParametersToGet(query, parameters);
        return this.http.get<EntTicketVenta>(
            Parametros.GetParametros().servidorLocal + consulta,
            this.httpOptions
        );
    }
    ...
    public getDescuentosCientes(codCliente: number): Observable<any[]> {
        ...
        const parameters = [[codCliente, 'codCliente']];
        const consulta = OrderParametersToGet(query, parameters);
        return this.http.get<any[]>(
            Parametros.GetParametros().servidorLocal + consulta,
            this.httpOptions
    ...
    public InsertOrder(
        ...
        return this.http
            .post<EntOrder>(
                Parametros.GetParametros().servidorLocal + '/api/order',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertUser(user: EntUserDB): Observable<EntUserDB> {
        ...
        return this.http
            .post<EntUserDB>(
                Parametros.GetParametros().servidorLocal + '/api/user',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertOption(option: EntOption): Observable<EntOption> {
        ...
        return this.http
            .post<EntOption>(
                Parametros.GetParametros().servidorLocal + '/api/option',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertProfile(profile: EntProfile): Observable<EntProfile> {
        ...
        return this.http
            .post<EntProfile>(
                Parametros.GetParametros().servidorLocal + '/api/profile',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertRole(role: EntRole): Observable<EntRole> {
        ...
        return this.http
            .post<EntRole>(
                Parametros.GetParametros().servidorLocal + '/api/role',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public AssignProfile(
        ...
        return this.http
            .post<any>(
                Parametros.GetParametros().servidorLocal + '/api/assignProfile',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertQuota(quota: EntQuota): Observable<any> {
        ...
        return this.http
            .post(
                Parametros.GetParametros().servidorLocal + '/api/quota',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertTask(task: EntTask): Observable<any> {
        ...
        return this.http
            .post(
                Parametros.GetParametros().servidorLocal + '/api/task',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertVehicle(vehicle: EntVehicle): Observable<any> {
        ...
        return this.http
            .post(
                Parametros.GetParametros().servidorLocal + '/api/vehicle',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertIdenfier(identifier: EntIdentifier): Observable<any> {
        ...
        return this.http
            .post(
                Parametros.GetParametros().servidorLocal + '/api/identifier',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertWholesalerPayment(
        payments: EntInvoice[],
        date: string
    ): Observable<any> {
    ...
    public AssignPayment(cuentaCobro: number, pago: number): Observable<any> {
        ...
        return this.http
            .post<any>(
                Parametros.GetParametros().servidorLocal + '/api/assignPayment',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertInvoice(invoice: EntInvoice): Observable<any> {
        ...
        return this.http
            .post(
                Parametros.GetParametros().servidorLocal + '/api/invoice',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertNoveltyInvoice(
        noveltyInvoice: EntNoveltyInvoice
    ): Observable<any> {
    ...
    public InsertAdvance(advance: EntAdvance): Observable<any> {
        ...
        return this.http
            .post(
                Parametros.GetParametros().servidorLocal + '/api/advance',
                body,
                this.httpOptions
            )
            .pipe(
    ...
    public InsertNoveltyAdvance(
        noveltyAdvance: EntNoveltyAdvance
    ): Observable<any> {
        const body = JSON.stringify(noveltyAdvance);
        return this.http.post(
            Parametros.GetParametros().servidorLocal + '/api/noveltyAdvance',
            body,
            this.httpOptions
        );
    }
    ...
    public GetVehicleWithoutOrder(codClient: number): Observable<EntVehicle[]> {
        return this.http.get<EntVehicle[]>(
            Parametros.GetParametros().servidorLocal +
                '/api/vehicleWithoutOrder/?codClient=' +
                codClient,
            this.httpOptions
        );
    }
    ...
    public GetIdentifierFree(codClient: number): Observable<EntIdentifier[]> {
        return this.http.get<EntIdentifier[]>(
            Parametros.GetParametros().servidorLocal +
                '/api/identifierFree/?codClient=' +
                codClient,
            this.httpOptions
        );
    }
    ...
    public getCity(): Observable<EntCity[]> {
        return this.http.get<EntCity[]>(
            Parametros.GetParametros().servidorLocal + '/api/city',
            this.httpOptions
        );
    }

    public getCityStation(): Observable<EntCityStation[]> {
        return this.http.get<EntCityStation[]>(
            Parametros.GetParametros().servidorLocal + '/api/cityStation',
            this.httpOptions
        );
    }
    ...
    public getQuotaType(): Observable<EntQuotaType[]> {
        return this.http
            .get<EntQuotaType[]>(
                Parametros.GetParametros().servidorLocal + '/api/quotaType',
                this.httpOptions
            )
            .pipe(tap((data) => console.log('Realizado con éxito')));
    }
    ...
    public getDiscount(codClient: number): Observable<EntDiscount[]> {
        ...
        const parameters = [[codClient, 'codClient']];
        const consulta = OrderParametersToGet(query, parameters);
        return this.http
            .get<EntDiscount[]>(
                Parametros.GetParametros().servidorLocal + consulta,
    ...
    public getHomeClient(codClient: number): Observable<EntHomeClient> {
        return this.http.get<EntHomeClient>(
            Parametros.GetParametros().servidorLocal +
                '/api/homeClient?codClient=' +
                codClient,
            this.httpOptions
        );
    }
    ...
    public getHomeStation(station: number): Observable<EntHomeStation> {
        return this.http.get<EntHomeStation>(
            Parametros.GetParametros().servidorLocal +
                '/api/homeStation?station=' +
                station,
            this.httpOptions
        );
    }
    ...
    public getSaldoIncicialCliente(
        idEstacion: number,
        fecha: string,
        cliente: number
    ): Observable<any> {
    ...
    public getCodContables(): Observable<any> {
        return this.http
            .get<any>(
                Parametros.GetParametros().servidorLocal + '/api/codcontable',
                this.httpOptions
            )
            .pipe(
                tap((result) => {
                    result.map((e) => {
                        e.Codigos != null
                            ? (e.Codigos = JSON.parse(String(e.Codigos)))
                            : null;
                    });
                })
            );
