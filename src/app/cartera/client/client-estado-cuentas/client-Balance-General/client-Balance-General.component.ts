...
export class ClientBalanceGeneralComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.searchConsumoFechaIni = this.FormatFecha(this.dateIni);
        this.searchConsumoFechaFin = this.FormatFecha(this.dateEnd);
        this.basicData();
        this.title.setTitle('Estado de Cuentas - Simovil');
    }
    resultClient($event) {
